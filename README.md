...
Optional AI builds
Install Ollama.
Pull a model, for example ollama pull mistral.
Start the local server with ollama serve.
Open the app and use the AI Build Suggester card.
Rate results from 1 to 5 stars to store local good/bad examples for future prompts.
